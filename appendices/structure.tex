...
Táto práca sa venuje analýze a praktickej realizácii prechodu webovej aplikácie z monolitickej architektúry na mikroservisný ekosystém, ktorý reflektuje aktuálne trendy v oblasti moderného softvérového inžinierstva. Cieľom bolo preskúmať, ako rozdiely v architektonickom návrhu ovplyvňujú škálovateľnosť, údržbu, nasadzovanie a celkovú flexibilitu aplikácie v dlhodobom horizonte.

V rámci práce boli vytvorené dve implementácie rovnakej aplikácie — pôvodná monolitická verzia a nová verzia založená na samostatných, nezávisle nasaditeľných mikroservisoch. Tento prístup umožnil komplexné porovnanie ich správania, prevádzkových vlastností a technických nárokov pri vývoji aj produkčnom nasadení. Zameral som sa najmä na komunikáciu medzi službami, prácu s dátami, oddelenie logiky a možnosti paralelného vývoja jednotlivých komponentov.

Získané výsledky poukazujú na to, že mikroservisná architektúra dokáže výrazne zvýšiť modularitu a umožňuje jednoduchšie škálovanie systému, zatiaľ čo monolitická verzia stále ponúka nižšiu komplexitu a jednoduchší začiatok vývoja. Pre študentov a vývojárov predstavuje mikroservisný prístup cennú skúsenosť, ktorá zahŕňa prácu s kontajnermi, orchestrace služieb, distribuované prostredia a moderné DevOps postupy, čo sú dnes nevyhnutné zručnosti v profesionálnej praxi.

Verím, že táto práca poskytne čitateľom nielen ucelený pohľad na rozdiely medzi architektúrami, ale aj praktické poznatky, ktoré môžu pomôcť pri rozhodovaní o návrhu budúcich projektov a pri ďalšom technickom rozvoji v oblasti softvérovej architektúry.
