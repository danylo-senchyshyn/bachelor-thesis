...
│       └── resources/
│           └── application.yml   -- DB, JPA, server konfigurácia
├── docs/
│   └── diagrams/                 -- architektonické diagramy (PNG)
...
│   │       └── outbox/           -- OutboxEventPublisher (scheduler)
│   ├── payment-service/
│   │   └── src/main/java/.../
│   │       ├── service/          -- PaymentService
...
│           ├── repository/       -- NotificationLogRepository
│           └── kafka/            -- listener
├── db_init/                      -- SQL inicializácia schém DB
├── docs/
│   └── diagrams/                 -- architektonické diagramy (PNG)
