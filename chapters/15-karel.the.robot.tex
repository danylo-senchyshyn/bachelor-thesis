...
\chapter{(Mikro)svet Robota Karla}\label{ch:karel.the.robot}
...
\begin{figure}[htbp]
    ...
    \caption[Richard Pattis bojujúci s umelou inteligenciou]{Richard Pattis bojujúci s umelou inteligenciou (1976) \footnotemark }
    \label{fig:pattis}
\end{figure}
...
\emph{Robota Karla} je možné ovládať pomocou niekoľkých príkazov, nazývaných tiež \emph{primitívne funkcie} alebo len \emph{\glslink{primitive}{primitívy}}. Ich názvy z pôvodného jazyka v \cite{Pattis1994} spolu s opisom ich funkcionality sa nachádzajú v tabuľke \ref{tab:karels_primitives}.

\begin{table}[!ht]
	\caption{Príkazy Robota Karla}\label{tab:karels_primitives}
	\smallskip
	\centering
...
\emph{Robot Karel} obsahuje niekoľko senzorov, ktoré je možné použiť vtedy, keď sa v rámci programu potrebuje rozhodnúť.
...
Zoznam jednotlivých senzorov, ich názvy z pôvodného jazyka v \cite{Pattis1994} spolu s opisom ich funkcionality sa nachádzajú v tabuľke \ref{tab:karels_sensors}.

\begin{table}[!ht]
	\caption{Senzory Robota Karla}\label{tab:karels_sensors}
	\smallskip
	\centering
   ...
   \begin{tabular}{l|p{80mm}}
		...
		\verb|front-is-clear| & vráti hodnotu \verb|true|, ak pred \emph{Karlom} nie je stena alebo hranica sveta, inak vráti hodnotu \verb|false| \\
		\verb|next-to-a-beeper| & vráti hodnotu \verb|true|, ak \emph{Karel} stojí na značke, inak vráti hodnotu \verb|false| \\
		\verb|any-beepers-in-beeper-bag| & vráti hodnotu \verb|true|, ak má \emph{Karel} v batohu aspoň $1$ značku, inak vráti hodnotu \verb|false| \\
		\verb|facing-north| & vráti hodnotu \verb|true|, ak je \emph{Karel} otočený smerom na sever, inak vráti hodnotu \verb|false| \\
		\bottomrule
	\end{tabular}
\end{table}
