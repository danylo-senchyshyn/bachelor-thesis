...
Konkrétne požiadavky úlohy sú:

Táto kapitola konkretizuje zadanie bakalárskej práce a definuje požiadavky kladené
na navrhované riešenia. Požiadavky sú formulované tak, aby zabezpečili funkčnú
ekvivalenciu oboch architektonických prístupov a umožnili ich objektívne
porovnanie z hľadiska implementácie, prevádzky a údržby. Osobitne sú špecifikované
požiadavky pre monolitickú a mikroservisnú verziu aplikácie.
