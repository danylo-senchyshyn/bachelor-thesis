...
\emph{Robot Karel} obsahuje niekoľko senzorov, ktoré je možné použiť vtedy, keď sa v rámci programu potrebuje rozhodnúť. Ich názvy z pôvodného jazyka v \cite{Pattis1994} spolu s opisom ich funkcionality sa nachádzajú v tabuľke \ref{tab:karels_sensors}.
