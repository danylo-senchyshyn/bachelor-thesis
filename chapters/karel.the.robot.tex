...
\emph{Robota Karla} je možné ovládať pomocou niekoľkých príkazov, nazývaných tiež \emph{primitívne funkcie} alebo len \emph{primitívy}. Ich názvy z~pôvodného jazyka v~\cite{Pattis1994} spolu s~opisom ich funkcionality sa nachádzajú v~tabuľke \ref{tab:karels_primitives}.
