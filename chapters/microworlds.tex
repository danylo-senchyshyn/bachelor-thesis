...
\lstinputlisting[language={Logo},caption={Ukážka programu v~jazyku Imagine Logo}]{listings/turtle.txt}\label{lst:imagine.logo}
...
Jazyk \emph{Baltík}\footnote{\url{http://www.sgpsys.com/cz/Product_B3.asp}} vyvinula česká spoločnosť \emph{SGP Systems}\footnote{\url{http://www.sgpsys.com/cz/}} v~roku 1996. Je určený na výuku programovania na základných a stredných školách.
