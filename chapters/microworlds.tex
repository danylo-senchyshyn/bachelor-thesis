...
V~nasledujúcich podkapitolách sa nachádza prehľad niektorých známych mikrosvetov v~našom regióne. Mikrosvet \emph{Robota Karla} bude predstavený v~samostatnej kapitole \ref{chap: karel the robot}.
...
\emph{Robot Karel} býva taktiež témou záverečných prác na univerzitách v~Čechách a na Slovensku. Aj v~rámci našej univerzity sa niektoré záverečné práce venovali tejto téme. Napr. v~diplomovej práci \cite{Valo2012} sa diplomant venoval vytvoreniu 3D verzie \emph{Robota Karla}, ktorý by bol programovateľný cez sieť. Alebo v~bakalárskej práci \cite{Parackova2017} sa bakalárantka venovala možnosti testovania úloh pre \emph{Robota Karla} pomocou testovacej platformy \emph{Aréna}.
