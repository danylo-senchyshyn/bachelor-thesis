...
Cieľom mojej práce je vytvoriť knižnicu pre programovací jazyk \emph{C}, ktorá bude reprezentovať svet \emph{Robota Karla}, a pomocou ktorej bude možné \emph{Robota Karla} aj ovládať. Moje ciele, ktoré by som chcel dosiahnuť pri napĺňaní cieľa, som zhrnul do nasledujúcich bodov:
