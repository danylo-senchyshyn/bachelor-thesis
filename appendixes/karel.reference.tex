...
\chapter{Referenčná príručka modulu karel}\label{app:karel}

Tento modul obsahuje základné primitívy a základné senzory \emph{Robota Karla}.


\section*{Primitívy Robota Karla}

\begin{itemize}
    \item \verb|void step()| - Moves \textit{Karel} one intersection forward.
