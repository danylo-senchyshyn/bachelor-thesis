...
%\hyphenation{su-per-ka-rel}
\chapter{Referenčná príručka modulu superkarel}
\label{appendix:superkarel}


Tento modul rozširuje základný modul \verb|karel.h| o ďalšie primitívy a senzory.
