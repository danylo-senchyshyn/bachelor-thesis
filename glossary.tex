...
\newglossaryentry{microworld}
{
     name={Mikrosvet},
     description={je zjednodušené, samostatné prostredie navrhnuté tak, aby pomáhalo študentom skúmať a porozumieť špecifickým konceptom prostredníctvom priamej interakcie a experimentovania.}
}